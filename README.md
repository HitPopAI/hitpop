...
9 agents + 24 skills. Say "make me a video" → get a finished video.
...
| 4 | 💻 **Producer** | Master Craftsman | Executes all technical work via 24 skills |
...
24 skills that Producer uses as its toolbox. All in `skills/`:
