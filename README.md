...
9 agents + 22 skills. Say "make me a video" → get a finished video.
...
| 4 | 💻 **Producer** | Master Craftsman | Executes all technical work via 22 skills |
...
22 skills that Producer uses as its toolbox. All in `skills/`:
